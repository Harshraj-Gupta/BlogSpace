...
function createCard(title, category, description) {
  ...
  if (category === "Technology") imgTag.src = "./Tech.jpg";
  ...
  else if (category === "Business") imgTag.src = "./bus.jpeg";
  else if (category === "Health") imgTag.src = "./health.webp";
  else if (category === "Education") imgTag.src = "./Educ.jpeg";
  else if (category === "Entertainment")
    imgTag.src = "./Entertainment.jpg";
  imgTag.alt = "Food";
